...
#include UE_INLINE_GENERATED_CPP_BY_NAME(AttachedUserWidget)


void UAttachedUserWidget::AddToRootCanvasPanel(UUserWidget* InNewWidget)
{
...
void UAttachedUserWidget::NativeTick(const FGeometry& MyGeometry, float InDeltaTime)
{
...
void UAttachedUserWidget::NativeConstruct()
{
