...
UAsyncTaskCooldownChanged* UAsyncTaskCooldownChanged::ListenForCooldownChange(UAbilitySystemComponent* AbilitySystemComponent, FGameplayTagContainer CooldownTags, bool UseServerCooldown)
{
	...
	ListenForCooldownChange->CooldownTags = CooldownTags;
	ListenForCooldownChange->UseServerCooldown = UseServerCooldown;
